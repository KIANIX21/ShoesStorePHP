                ...
                <div class="col-sm-9 col-md-7 col-lg-4 mx-auto">
                    ...
                    <?php if (!empty($_GET["error"])): ?>
                        ...
                        <div class="card-body p-4 p-sm-5">
                            <h2 class="card-title text-center mb-5 fw-bold text-dark" style="font-family: cursive;">Sign up</h2>
                            <form method="post" action="../controller/control_signup.php">
                                ...
                                <div class="input-group mb-3">
                                    <input type="password" class="form-control" id="repassword" name="repassword" placeholder="Re-Password" value="">
                                </div>
