...
<body>
        ...
        <nav class="nav bd-container">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item"><a href="#product" class="nav__link active-link">Product</a></li>
    ...
    <main class="l-main">
        <section class="product section bd-container" id="products">
            ...
            <a href="Sepatu Anak.php"><button class="button" style="color: white;">See All</button></a>
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo '<div class="products__content">
                    ...
                    <a href="show.php?id=' . $productid .'" class="button products__button_detail">Product Detail</a>
        ...
        <section class="product section bd-container" id="products">
            ...
            <a href="Sepatu Wanita.php"><button class="button" style="color: white;">See All</button></a>
            <div class="products__container bd-grid slick_two">
            <?php
            while ($row1 = mysqli_fetch_assoc($result1)) {
                ...
                echo '<div class="products__content">
                    ...
                    <span class="products__price">'. 'Rp.'. ' ' . number_format($price,0) .'</span>
                    <a href="show.php?id=' . $row1['id_prod'] .'" class="button products__button_detail">Product Detail</a>
                    <a href="#" class="button products__button"><i class="bx bx-cart-alt"></i></a>
                </div>';
            }
            ?>
        ...
        <section class="product section bd-container" id="products">
            ...
            <a href="Sepatu Laki.php"><button class="button" style="color: white;">See All</button></a>
            <div class="products__container bd-grid slick_two">
            <?php
            while ($row2 = mysqli_fetch_assoc($result2)) {
                ...
                echo '<div class="products__content">
                    ...
                    <span class="products__price">'. 'Rp.'. ' ' . number_format($price,0) .'</span>
                    <a href="show.php?id=' . $row2['id_prod'] .'" class="button products__button_detail">Product Detail</a>
                    <a href="#" class="button products__button"><i class="bx bx-cart-alt"></i></a>
                </div>';
            }
            ?>
